---
name: verify
description: Verify a change by running the app and observing it at its real surface (CLI, socket, pixels, package boundary) - not by running tests or typechecking. Use when asked to verify a diff, branch, or PR, or to confirm a change actually works.
